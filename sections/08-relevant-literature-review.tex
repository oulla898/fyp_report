...
\subsubsection{Mobile Robot Platform Selection}
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Autonomous docking and charging}: The platform must support autonomous return-to-base functionality with a charging dock, enabling unattended operation and automatic battery management. High-level API commands such as \texttt{dock()} or \texttt{return\_to\_charge()} are essential for seamless integration with the navigation stack.
    
    \item \textbf{ROS/ROS 2 compatibility}: Native support for the Robot Operating System is required to leverage existing navigation packages (Nav2, SLAM Toolbox, AMCL) and facilitate rapid development and integration of custom behaviors.
    
    \item \textbf{Payload capacity}: The platform must support 5--10~kg of additional payload to accommodate a telepresence screen (tablet or monitor), onboard computer (Raspberry Pi or Jetson Nano), camera system, and potential accessories such as speakers or mounting hardware.
    
    \item \textbf{Indoor navigation sensors}: Integration points for LiDAR (2D or 3D), depth cameras, or other sensors required for SLAM-based autonomous navigation in dynamic hospital environments.
    
    \item \textbf{Safety and reliability}: Cliff detection, bumper sensors, emergency stop functionality, and predictable motion control to ensure safe operation around patients, visitors, and medical staff.
\end{itemize}
...
Table~\ref{tab:platforms} presents a comparative analysis of commercially available mobile robot platforms evaluated against the project requirements. Platforms are categorized by cost tier and assessed on key criteria including autonomous docking capability, ROS compatibility, payload capacity, and suitability for healthcare telepresence applications.
...
\hline
iRobot Create 3 & \$549 & Yes & ROS 2 & 9~kg & Roomba-based, proven docking, ideal for education \\
\hline
Kobuki Base (used) & \$500--700 & Yes & ROS 1/2 & 5~kg & TurtleBot 2 base, discontinued but widely available \\
\hline
Yahboom ROSMASTER X3 & \$699 & DIY & ROS 1 & 5--8~kg & Mecanum wheels, requires custom docking solution \\
\hline
Elephant Robotics MyAGV 2023 & \$899 & DIY & ROS 1 & 8~kg & Mecanum wheels, 2D SLAM ready, Python/ROS compatible \\
\hline
\multicolumn{6}{|c|}{\textit{Mid Tier (\$1,000--\$2,000)}} \\
\hline
SLAMTEC Apollo & \$1,200 & Yes & ROS 1/2 & 50~kg & Same platform as Pudu/Keenon hospital robots \\
\hline
TurtleBot 4 Standard & \$1,400 & Yes & ROS 2 & 9~kg & Research-grade, Nav2 pre-configured, Lidar included \\
\hline
Husarion ROSbot 2R & \$1,600 & Optional & ROS 2 & 10~kg & Mecanum wheels, hospital navigation demos available \\
\hline
AgileX LIMO Pro & \$1,799 & Optional & ROS 2 & 10~kg & 4-mode steering, Jetson Nano, research platform \\
\hline
\multicolumn{6}{|c|}{\textit{High-End / Not Suitable}} \\
\hline
Clearpath Jackal & \$18,000+ & Optional & ROS 1/2 & 20~kg & Industrial-grade, exceeds budget \\
\hline
Rover Robotics Zero & \$2,500+ & \$950 & ROS 1/2 & 22~kg & Outdoor-rated, dock sold separately \\
\hline
\end{tabular}
\caption{Comparative analysis of mobile robot platforms for healthcare telepresence applications \cite{irobot2024create3, slamtec2024, turtlebot2024, yahboom2024, elephantrobotics2024, agilex2024, husarion2024}.}
\label{tab:platforms}
\end{table}

\paragraph{Platform Selection Rationale.}
The \textbf{iRobot Create 3} is selected as the optimal platform based on cost-effectiveness, proven reliability, and feature completeness \cite{irobot2024create3}. At \$549 with an included autonomous charging dock, it eliminates the \$800--\$950 docking station costs required by competing platforms. The platform leverages Roomba's decade-proven docking technology, offers native ROS 2 support with Nav2 compatibility, and provides sufficient 9~kg payload for a tablet display, Raspberry Pi 4, and camera system. Safety features including cliff detection and bump sensors ensure safe operation in patient areas.

While alternatives like SLAMTEC Apollo (\$1,200) \cite{slamtec2024} offer higher payload (50~kg) and are deployed in hospital robots, or TurtleBot 4 (\$1,400) \cite{turtlebot2024} provides integrated LiDAR, both exceed budget constraints. Budget options like Yahboom ROSMASTER X3 (\$699) \cite{yahboom2024} or Elephant Robotics MyAGV (\$899) \cite{elephantrobotics2024} offer mecanum mobility but lack proven autonomous docking, introducing development risk.
