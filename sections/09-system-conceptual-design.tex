...
\begin{table}[H]
\centering
\caption{Criteria Pairwise Comparison Matrix}
\begin{tabular}{lcccc}
\toprule
...
\begin{table}[H]
\centering
\caption{Alternative Scores by Criterion}
\begin{tabular}{lcccc}
\toprule
...
For the conversational AI component, three state-of-the-art LLM options are evaluated: OpenAI GPT-4 Turbo, Anthropic Claude 3.5 Sonnet, and Google Gemini 3.0 pro (announced December 2024).
...
\textbf{Google Gemini 3.0 pro} is selected based on its superior AHP score. Key advantages include:
\begin{itemize}
