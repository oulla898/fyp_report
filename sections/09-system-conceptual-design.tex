...
For the conversational AI component, three state-of-the-art LLM options are evaluated: OpenAI GPT-4 Turbo, Anthropic Claude 3.5 Sonnet, and Google Gemini 3 flash (announced December 2024).
...
\textbf{Gemini 3 flash} & \textbf{8.44} \\
\bottomrule
\end{tabular}
\end{table}
